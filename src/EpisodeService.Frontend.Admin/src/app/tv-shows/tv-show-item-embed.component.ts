...
const template = require("./tv-show-item-embed.component.html");
const styles = require("./tv-show-item-embed.component.scss");

export class TvShowItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new TvShowDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new TvShowEdit(this.entity));
    }
    ...
    public entity: TvShow;
}

customElements.define(`ce-tv-show-item-embed`,TvShowItemEmbedComponent);
