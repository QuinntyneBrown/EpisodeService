...
const template = require("./episode-item-embed.component.html");
const styles = require("./episode-item-embed.component.scss");

export class EpisodeItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new EpisodeDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new EpisodeEdit(this.entity));
    }
...
customElements.define(`ce-episode-item-embed`,EpisodeItemEmbedComponent);
